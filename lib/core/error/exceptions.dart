...
class ServerException extends DioException implements Exception {
  ServerException({required RequestOptions requestOptions, Response? response, DioExceptionType type = DioExceptionType.unknown, dynamic error, StackTrace? stackTrace})
      : super(requestOptions: requestOptions, response: response, type: type, error: error, stackTrace: stackTrace);
